# Week 2 Mini Project Problem 3
# 3.	Basic Weather Data Lookup
# •	Description: Create a simple program where users input a city name, and the program provides a mock weather report. Use lambda functions to parse and display formatted weather data.
# •	Concepts Covered:
# •	Function scope and variable management.
# •	Lambda functions to filter or format data.
# •	Global and local variable use for storing weather data.
# •	Stretch Goal: Add error handling for invalid city names
